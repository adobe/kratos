...
func (in *KratosStatus) DeepCopyInto(out *KratosStatus) {
	*out = *in
	if in.StabilizationEndTime != nil {
		in, out := &in.StabilizationEndTime, &out.StabilizationEndTime
		*out = (*in).DeepCopy()
	}
	...
	if in.ScaleUpEvents != nil {
		in, out := &in.ScaleUpEvents, &out.ScaleUpEvents
		*out = make([]ScaleChangeEvent, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ScaleDownEvents != nil {
		in, out := &in.ScaleDownEvents, &out.ScaleDownEvents
		*out = make([]ScaleChangeEvent, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
